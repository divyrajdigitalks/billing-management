...
import { BillData, getNextBillNo } from '../../services/billService';
...
export default function BillEntry() {
  ...
  const handleOpenAddForm = async () => {
    ...
    try {
      const res = await getNextBillNo();
      if (res && res.nextBillNo) {
        formik.setFieldValue('billNo', res.nextBillNo.toUpperCase());
      }
    } catch (err) {
      console.error('Failed to load next autogenerated bill number', err);
    }
  };
